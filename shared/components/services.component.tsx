  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="grid gap-4 mt-5 w-full md:grid-cols-2">
        ...
        <div className="p-4 md:p-8 bg-base-color rounded-lg hover:bg-gradient-to-br hover:from-hover-from hover:via-hover-from hover:via-30% hover:to-hover-to">
          <p className="text-lg md:text-2xl mb-3 font-semibold">Полірування фар</p>
          <p className="text-base md:text-lg font-golos-regular opacity-70">Відновлення прозорості фар для кращої видимості та безпеки.</p>
          <p className="font-golos-regular mt-7 font-semibold">5 000 - 10 000грн</p>
        </div>
      </div>
    </div>
